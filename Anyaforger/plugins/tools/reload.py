...
from Anyaforger.utils.database import get_assistant, get_authuser_names, get_cmode
from Anyaforger.utils.decorators import ActualAdminCB, AdminActual, language
from Anyaforger.utils.formatters import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await Anya.stop_stream_force(chat_id)
        except:
            pass
             ...
             [
                 [
                      InlineKeyboardButton(
                         "• нαϲкє𝚍 ву  •", url=f"https://t.me/gojo_104")
                 ]
            ]
         ),
     )
